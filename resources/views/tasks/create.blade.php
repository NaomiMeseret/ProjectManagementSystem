<x-layouts::app :title="__('Create Task')">
    <section class="space-y-6">
        <div class="pm-panel p-6 md:p-8">
            <p class="pm-eyebrow">{{ __('Task Planning') }}</p>
            <h1 class="pm-title mt-3">{{ __('Create Task') }}</h1>
            <p class="pm-subtitle mt-3">{{ __('Add a new task under :project and assign it to the right developer.', ['project' => $project->name]) }}</p>
        </div>
